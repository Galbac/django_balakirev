...
class Women(models.Model):
    ...
    title = models.CharField(max_length=255, validators=[MinLengthValidator(5), MaxLengthValidator(100)],
                             verbose_name='Заголовок')
    slug = models.SlugField(max_length=255, db_index=True, unique=True, validators=[
        MinLengthValidator(5),
        MaxLengthValidator(100),
    ])
    photo = models.ImageField(upload_to='photos/%Y/%m/%d', blank=True,default=None, null=True,verbose_name='Фото')
